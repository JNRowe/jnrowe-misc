 ...
 * Versions:
  ...
  * `0.4.3-r1 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-python/html2data/html2data-0.4.3-r1.ebuild>`__  ``~amd64`` (due 2014-09-03), ``~x86`` (due 2014-09-18)
 ...
 * Versions:
  ...
  * `0.6.8 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-python/pyhistorian/pyhistorian-0.6.8.ebuild>`__  ``~amd64`` (due 2014-08-28), ``~x86`` (due 2014-08-28)
 ...
 * Versions:
  ...
  * `0.4 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-python/rstctl/rstctl-0.4.ebuild>`__  ``~amd64`` (due 2014-09-04), ``~x86`` (due 2014-09-06)
 ...
 * Versions:
  ...
  * `1.0.0 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-python/showme/showme-1.0.0.ebuild>`__  ``~amd64`` (due 2014-09-21), ``~x86`` (due 2014-09-06)
