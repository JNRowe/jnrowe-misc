 ...
 * Versions:
  ...
  * `0.4.3-r1 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-python/html2data/html2data-0.4.3-r1.ebuild>`__  ``~amd64`` (due 2014-10-18), ``~x86`` (due 2014-10-18)
 ...
 * Versions:
  ...
  * `0.2 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-python/pycukes/pycukes-0.2.ebuild>`__  ``~amd64`` (due 2014-10-27), ``~x86`` (due 2014-10-12)
