 ...
 * Versions:
  ...
  * `0.5 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-python/aaargh/aaargh-0.5.ebuild>`__  ``~amd64`` (due 2013-12-07), ``~x86`` (due 2013-11-22)
 ...
 * Versions:
  ...
  * `0.6.8 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-python/pyhistorian/pyhistorian-0.6.8.ebuild>`__  ``~amd64`` (due 2013-11-16), ``~x86`` (due 2013-12-01)
