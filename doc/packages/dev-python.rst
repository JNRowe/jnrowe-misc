 ...
 * Versions:
  ...
  * `0.4.1 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-python/pep257/pep257-0.4.1.ebuild>`__  ``amd64``, ``x86``
 ...
 * Versions:
  ...
  * `0.2.2 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-python/pep8-naming/pep8-naming-0.2.2.ebuild>`__  ``amd64``, ``x86``
