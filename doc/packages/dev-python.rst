 ...
 * Versions:
  ...
  * `0.2.14 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-python/lettuce/lettuce-0.2.14.ebuild>`__  ``~amd64`` (due 2015-01-24), ``~x86`` (due 2014-12-10)
 ...
 * Versions:
  ...
  * `0.5.0 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-python/nose2/nose2-0.5.0.ebuild>`__  ``~amd64`` (due 2015-01-17), ``~x86`` (due 2015-01-02)
 ...
 * Versions:
  ...
  * `0.1.2 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-python/rad/rad-0.1.2.ebuild>`__  ``~amd64`` (due 2015-01-24), ``~x86`` (due 2014-12-25)
