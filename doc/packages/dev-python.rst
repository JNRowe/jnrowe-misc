 ...
 * Versions:
  ...
  * `0.7.1 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-python/aaargh/aaargh-0.7.1.ebuild>`__  ``~amd64`` (due 2014-04-17), ``x86``
 ...
 * Versions:
  ...
  * `1.2.4 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-python/behave/behave-1.2.4.ebuild>`__  ``~amd64`` (due 2014-04-17), ``x86``
 ...
 * Versions:
  ...
  * `0.3.2 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-python/pep257/pep257-0.3.2.ebuild>`__  ``~amd64`` (due 2014-04-17), ``x86``
