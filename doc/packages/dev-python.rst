 ...
 * Versions:
  ...
  * `0.2 <https://github.com/JNRowe/misc-overlay/blob/master/dev-python/genzshcomp/genzshcomp-0.2.ebuild>`__  ``amd64``, ``~x86`` (due 2011-03-18)
 ...
 * Versions:
  ...
  * `0.1.20 <https://github.com/JNRowe/misc-overlay/blob/master/dev-python/lettuce/lettuce-0.1.20.ebuild>`__  ``amd64``, ``~x86`` (due 2011-03-17)
