 ...
 * Versions:
  ...
  * `0.5.2 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-python/github2/github2-0.5.2.ebuild>`__  ``~amd64`` (due 2012-02-06), ``~x86`` (due 2011-11-05)
 ...
 * Versions:
  ...
  * `0.4 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-python/rstctl/rstctl-0.4.ebuild>`__  ``~amd64`` (due 2012-02-04), ``~x86`` (due 2011-11-06)
