 ...
 * Versions:
  ...
  * `0.8.1 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-python/poster/poster-0.8.1.ebuild>`__  ``amd64``, ``~x86`` (due 2011-09-25)
 ...
 * Versions:
  ...
  * `0.6.1 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-python/requests/requests-0.6.1.ebuild>`__  ``amd64``, ``~x86`` (due 2011-09-25)
