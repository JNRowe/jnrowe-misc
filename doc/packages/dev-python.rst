 ...
 * Versions:
  ...
  * `0.2.14 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-python/lettuce/lettuce-0.2.14.ebuild>`__  ``~amd64`` (due 2014-03-15), ``~x86`` (due 2014-02-13)
 ...
 * Versions:
  ...
  * `0.2 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-python/pycukes/pycukes-0.2.ebuild>`__  ``~amd64`` (due 2014-03-16), ``~x86`` (due 2014-02-14)
