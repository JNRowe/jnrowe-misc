 ...
 * Versions:
  ...
  * `3.0.7 <https://github.com/JNRowe/misc-overlay/blob/master/dev-python/commandlineapp/commandlineapp-3.0.7.ebuild>`__  ``amd64``, ``~x86`` (due 2011-03-31)
 ...
 * Versions:
  ...
  * `0.1.21 <https://github.com/JNRowe/misc-overlay/blob/master/dev-python/lettuce/lettuce-0.1.21.ebuild>`__  ``amd64``, ``~x86`` (due 2011-03-31)
