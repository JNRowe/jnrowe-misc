 ...
 * Versions:
  ...
  * `0.2.14 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-python/lettuce/lettuce-0.2.14.ebuild>`__  ``~amd64`` (due 2014-06-13), ``~x86`` (due 2014-06-13)
 ...
 * Versions:
  ...
  * `0.6.8 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-python/pyhistorian/pyhistorian-0.6.8.ebuild>`__  ``~amd64`` (due 2014-05-30), ``~x86`` (due 2014-05-30)
 ...
 * Versions:
  ...
  * `0.4 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-python/rstctl/rstctl-0.4.ebuild>`__  ``~amd64`` (due 2014-06-06), ``~x86`` (due 2014-06-08)
