 ...
 * Versions:
  ...
  * `0.5.2 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-python/attest/attest-0.5.2.ebuild>`__  ``~amd64`` (due 2012-02-19), ``~x86`` (due 2012-01-24)
 ...
 * Versions:
  ...
  * `0.13.6 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-python/gevent/gevent-0.13.6.ebuild>`__  ``~amd64`` (due 2011-12-24), ``~x86`` (due 2012-02-22)
 ...
 * Versions:
  ...
  * `0.7.3 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-python/requests/requests-0.7.3.ebuild>`__  ``~amd64`` (due 2011-12-25), ``~x86`` (due 2012-02-23) (masked by ``package.mask``)
 ...
 * Versions:
  ...
  * `0.6 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-python/snot/snot-0.6.ebuild>`__  ``~amd64`` (due 2012-01-16), ``~x86`` (due 2012-01-16)
