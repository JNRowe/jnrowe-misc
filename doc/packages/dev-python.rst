 ...
 * Versions:
  ...
  * `0.4 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-python/rstctl/rstctl-0.4.ebuild>`__  ``~amd64`` (due 2014-03-08), ``~x86`` (due 2014-02-08)
 ...
 * Versions:
  ...
  * `1.0.0 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-python/showme/showme-1.0.0.ebuild>`__  ``amd64``, ``~x86`` (due 2014-01-29)
