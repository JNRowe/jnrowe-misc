 ...
 * Versions:
  ...
  * `0.4.1-r2 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-vcs/gitflow/gitflow-0.4.1-r2.ebuild>`__  ``~amd64`` (indefinite), ``~x86`` (due 2012-07-15)
 ...
 * Versions:
  ...
  * `0.3.1 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-vcs/pepper/pepper-0.3.1.ebuild>`__  ``amd64``, ``x86``
  * `0.3.2 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-vcs/pepper/pepper-0.3.2.ebuild>`__  ``~amd64`` (due 2012-07-15), ``~x86`` (due 2012-07-15)
