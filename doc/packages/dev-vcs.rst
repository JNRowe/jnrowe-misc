 ...
 * Versions:
  ...
  * `0.4.1-r2 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-vcs/gitflow/gitflow-0.4.1-r2.ebuild>`__  ``~amd64`` (due 2012-05-16), ``~x86`` (due 2012-05-16)
 ...
 * Versions:
  ...
  * `0.3.1 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-vcs/pepper/pepper-0.3.1.ebuild>`__  ``amd64``, ``~x86`` (due 2012-04-18)
