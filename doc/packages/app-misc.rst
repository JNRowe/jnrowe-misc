 ...
 * Versions:
  ...
  * `0.1.4 <https://github.com/JNRowe/jnrowe-misc/blob/master/app-misc/hammertime/hammertime-0.1.4.ebuild>`__  ``~amd64`` (due 2011-12-25), ``~x86`` (due 2011-12-25)
 ...
 * Versions:
  ...
  * `0.11.0 <https://github.com/JNRowe/jnrowe-misc/blob/master/app-misc/hubugs/hubugs-0.11.0.ebuild>`__  ``~amd64`` (due 2012-02-06), ``~x86`` (due 2012-02-04)
