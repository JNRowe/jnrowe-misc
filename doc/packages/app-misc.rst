 ...
 * Versions:
  ...
  * `0.2.4 <https://github.com/JNRowe/jnrowe-misc/blob/master/app-misc/Hammertime/Hammertime-0.2.4.ebuild>`__  ``~amd64`` (due 2014-07-20), ``~x86`` (due 2014-06-20)
 ...
 * Versions:
  ...
  * `1.10.0 <https://github.com/JNRowe/jnrowe-misc/blob/master/app-misc/pytrainer/pytrainer-1.10.0.ebuild>`__  ``~amd64`` (due 2014-06-11), ``~x86`` (due 2014-07-11)
