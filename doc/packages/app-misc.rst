 ...
 * Versions:
  ...
  * `0.11.3 <https://github.com/JNRowe/jnrowe-misc/blob/master/app-misc/rdial/rdial-0.11.3.ebuild>`__  ``~amd64`` (due 2013-04-24), ``~x86`` (due 2013-04-24)
  * `0.12.0 <https://github.com/JNRowe/jnrowe-misc/blob/master/app-misc/rdial/rdial-0.12.0.ebuild>`__  ``~amd64`` (due 2013-04-19), ``~x86`` (due 2013-04-19)
