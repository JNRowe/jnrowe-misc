 ...
 * Versions:
  ...
  * `0.17.4 <https://github.com/JNRowe/jnrowe-misc/blob/master/app-misc/hubugs/hubugs-0.17.4.ebuild>`__  ``~amd64`` (due 2014-02-24)
 ...
 * Versions:
  ...
  * `0.2.3 <https://github.com/JNRowe/jnrowe-misc/blob/master/app-misc/pw/pw-0.2.3.ebuild>`__  ``~amd64`` (due 2014-02-14), ``~x86`` (due 2014-03-01)
 ...
 * Versions:
  ...
  * `1.10.0 <https://github.com/JNRowe/jnrowe-misc/blob/master/app-misc/pytrainer/pytrainer-1.10.0.ebuild>`__  ``~amd64`` (due 2014-03-13), ``~x86`` (due 2014-02-11)
