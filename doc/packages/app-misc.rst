 ...
 * Versions:
  ...
  * `1.9.1 <https://github.com/JNRowe/jnrowe-misc/blob/master/app-misc/pytrainer/pytrainer-1.9.1.ebuild>`__  ``~amd64`` (due 2013-01-09), ``~x86`` (due 2013-02-08)
 ...
 * Versions:
  ...
  * `1.10 <https://github.com/JNRowe/jnrowe-misc/blob/master/app-misc/weatherspect/weatherspect-1.10.ebuild>`__  ``amd64``, ``~x86`` (due 2013-01-07)
