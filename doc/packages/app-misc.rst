 ...
 * Versions:
  ...
  * `0.2.4 <https://github.com/JNRowe/jnrowe-misc/blob/master/app-misc/Hammertime/Hammertime-0.2.4.ebuild>`__  ``~amd64`` (due 2014-04-21), ``~x86`` (due 2014-03-22)
 ...
 * Versions:
  ...
  * `1.10.0 <https://github.com/JNRowe/jnrowe-misc/blob/master/app-misc/pytrainer/pytrainer-1.10.0.ebuild>`__  ``~amd64`` (due 2014-04-27), ``~x86`` (due 2014-03-13)
