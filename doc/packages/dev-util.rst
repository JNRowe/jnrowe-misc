 ...
 * Versions:
  ...
  * `0.2.3 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-util/cake/cake-0.2.3.ebuild>`__  ``~amd64`` (due 2013-10-16), ``~x86`` (due 2013-08-02)
 ...
 * Versions:
  ...
  * `0.5-r1 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-util/ditz/ditz-0.5-r1.ebuild>`__  ``~amd64`` (due 2013-07-25), ``~x86`` (due 2013-08-24)
