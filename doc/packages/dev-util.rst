 ...
 * Versions:
  ...
  * `0.2.3 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-util/cake/cake-0.2.3.ebuild>`__  ``~amd64`` (due 2014-01-14), ``~x86`` (due 2014-01-29)
 ...
 * Versions:
  ...
  * `0.5-r1 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-util/ditz/ditz-0.5-r1.ebuild>`__  ``~amd64`` (due 2014-03-07), ``~x86`` (due 2014-02-05)
