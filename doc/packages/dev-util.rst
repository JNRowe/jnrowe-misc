 ...
 * Versions:
  ...
  * `0.2.3 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-util/cake/cake-0.2.3.ebuild>`__  ``~amd64`` (due 2014-12-20), ``~x86`` (due 2014-12-05)
 ...
 * Versions:
  ...
  * `0.5-r1 <https://github.com/JNRowe/jnrowe-misc/blob/master/dev-util/ditz/ditz-0.5-r1.ebuild>`__  ``~amd64`` (due 2014-12-02), ``~x86`` (due 2015-01-01)
