 ...
 * Versions:
  ...
  * `0.4.1 <https://github.com/JNRowe/jnrowe-misc/blob/master/media-gfx/actdiag/actdiag-0.4.1.ebuild>`__  ``~amd64`` (due 2014-06-05), ``~x86`` (due 2014-04-21)
 ...
 * Versions:
  ...
  * `0.8.1 <https://github.com/JNRowe/jnrowe-misc/blob/master/media-gfx/seqdiag/seqdiag-0.8.1.ebuild>`__  ``~amd64`` (due 2014-04-21), ``~x86`` (due 2014-04-21)
