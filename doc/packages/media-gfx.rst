 ...
 * Versions:
  ...
  * `0.3.3 <https://github.com/JNRowe/jnrowe-misc/blob/master/media-gfx/gruffy/gruffy-0.3.3.ebuild>`__  ``~amd64`` (due 2016-02-10), ``~x86`` (due 2015-12-23)
 ...
 * Versions:
  ...
  * `0.1.1 <https://github.com/JNRowe/jnrowe-misc/blob/master/media-gfx/sphinxcontrib-gruffygen/sphinxcontrib-gruffygen-0.1.1.ebuild>`__  ``~amd64`` (due 2015-12-12), ``~x86`` (due 2016-01-25)
