 ...
 * Versions:
  ...
  * `0.4.1 <https://github.com/JNRowe/jnrowe-misc/blob/master/media-gfx/actdiag/actdiag-0.4.1.ebuild>`__  ``~amd64`` (due 2014-07-20), ``~x86`` (due 2014-08-19)
 ...
 * Versions:
  ...
  * `0.8.1 <https://github.com/JNRowe/jnrowe-misc/blob/master/media-gfx/seqdiag/seqdiag-0.8.1.ebuild>`__  ``~amd64`` (due 2014-07-20), ``~x86`` (due 2014-08-19)
