 ...
 * Versions:
  ...
  * `0.5-r3 <https://github.com/JNRowe/jnrowe-misc/blob/master/media-gfx/aafigure/aafigure-0.5-r3.ebuild>`__  ``~amd64`` (due 2013-10-08), ``x86``
 ...
 * Versions:
  ...
  * `1.2.4-r1 <https://github.com/JNRowe/jnrowe-misc/blob/master/media-gfx/blockdiag/blockdiag-1.2.4-r1.ebuild>`__  ``~amd64`` (due 2013-10-08), ``~x86`` (due 2013-10-08)
